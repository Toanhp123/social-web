            ...
            <>
              ...
              {postsQuery.hasNextPage && (
                <button
                  ...
                  className="rounded-pill border-surface-border bg-surface hover:bg-surface-soft text-primary w-full border px-4 py-2 text-sm font-semibold transition disabled:opacity-60"
                >
                  {postsQuery.isFetchingNextPage ? t.loadingMore : t.loadMore}
                </button>
              )}
            </>
          ) : (
